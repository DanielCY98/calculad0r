...
/*function Binario()//Error Fatal, esta operación hace operaciones infinitas y se bloquea
{
    var binari0 = document.getElementById("textoPantalla");
    var resultad0;
    var numer0;
    while(binari0 != 0)
    {
        numer0 = binari0 % 2;
        if (numer0 == 1)
        { resultad0 = resultad0 + "1"; }
        else
        { resultad0 = resultad0 + "0"; }
        binari0 = binari0 / 2;
        
    }
    pantalla.innerHTML=resultad0;
}*/
